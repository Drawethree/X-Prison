package dev.drawethree.ultraprisoncore.autosell.gui;
...
import dev.drawethree.ultraprisoncore.autosell.utils.SellPriceComparator;
...
public final class SellRegionGui extends Gui {
	...
	private void deleteSellPrice(CompMaterial material) {
		...
		UltraPrisonAutoSell.getInstance().getAutoSellConfig().saveSellRegion(sellRegion);
	}
}
