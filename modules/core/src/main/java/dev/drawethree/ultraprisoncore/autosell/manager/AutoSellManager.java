package dev.drawethree.ultraprisoncore.autosell.manager;
...
import dev.drawethree.ultraprisoncore.utils.economy.EconomyUtils;
import dev.drawethree.ultraprisoncore.utils.inventory.InventoryUtils;
import dev.drawethree.ultraprisoncore.utils.misc.MaterialUtils;
...
public class AutoSellManager {
    ...
    private UltraPrisonSellAllEvent callSellAllEvent(Player sender, SellRegion sellRegion, Map<AutoSellItemStack, Double> sellItems) {
        ...
        if (event.isCancelled()) {
            this.plugin.getCore().debug("UltraPrisonSellAllEvent was cancelled.", this.plugin);
        }
    ...
    private UltraPrisonAutoSellEvent callAutoSellEvent(Player player, SellRegion sellRegion, Map<AutoSellItemStack, Double> itemsToSell) {
        ...
        if (event.isCancelled()) {
            this.plugin.getCore().debug("UltraPrisonAutoSellEvent was cancelled.", this.plugin);
        }
