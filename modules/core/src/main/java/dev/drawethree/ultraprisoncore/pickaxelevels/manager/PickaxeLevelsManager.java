package dev.drawethree.ultraprisoncore.pickaxelevels.manager;
...
import static dev.drawethree.ultraprisoncore.pickaxelevels.utils.PickaxeLevelsUtils.NBT_TAG_INDETIFIER;

public class PickaxeLevelsManager {

	private final UltraPrisonPickaxeLevels plugin;

	public PickaxeLevelsManager(UltraPrisonPickaxeLevels plugin) {
		this.plugin = plugin;
	}
	...
	public String getDisplayName(PickaxeLevel level, Player p) {
		if (UltraPrisonCore.getInstance().isPlaceholderAPIEnabled()) {
