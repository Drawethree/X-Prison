...
public class GangPointsRemoveCommand extends GangPointsCommand {

	public GangPointsRemoveCommand(WildPrisonGangPoints plugin) {
		super(plugin);
	}
	...
	public boolean execute(CommandSender sender, ImmutableList<String> args) {
		...
		if (args.size() == 2) {
			try {
				...
				plugin.getGangPointsManager().removePoints(gang, amount, sender);
				return true;
