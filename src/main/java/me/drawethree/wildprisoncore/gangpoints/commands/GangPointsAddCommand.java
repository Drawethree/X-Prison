...
public class GangPointsAddCommand extends GangPointsCommand {

	public GangPointsAddCommand(WildPrisonGangPoints plugin) {
		super(plugin);
	}
	...
	public boolean execute(CommandSender sender, ImmutableList<String> args) {
		...
		if (args.size() == 2) {
			try {
				...
				plugin.getGangPointsManager().addPoints(gang, amount, sender);
				return true;
