...
public class KeyFinderEnchant extends WildPrisonEnchantment {
	...
	public void onBlockBreak(BlockBreakEvent e, int enchantLevel) {
		if (!LAST_CLAIMED.containsKey(e.getPlayer().getUniqueId()) || getDelayBetweenKeys(enchantLevel) <= TimeUnit.MILLISECONDS.toSeconds(Time.nowMillis() - LAST_CLAIMED.get(e.getPlayer().getUniqueId()))) {
