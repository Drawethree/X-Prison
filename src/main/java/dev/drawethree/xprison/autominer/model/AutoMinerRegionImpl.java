...
@Getter
public class AutoMinerRegionImpl implements AutoMinerRegion {
	...
	public AutoMinerRegionImpl(XPrisonAutoMiner plugin, World world, IWrappedRegion region, List<String> rewards, int rewardPeriod, int blocksBroken) {
		this.plugin = plugin;
		this.world = world;
		this.region = region;
