...
public class BlockPaletteImpl implements BlockPalette, GsonSerializable {
	...
	public BlockPaletteImpl() {
		this.blockPercentages = new HashMap<>();
	}

	private BlockPaletteImpl(Map<XMaterial, Double> blockPercentages) {
		this.blockPercentages = blockPercentages;
	}

	public static BlockPaletteImpl deserialize(JsonElement element) {
		...
		return new BlockPaletteImpl(blocks);
	}
	...
	public void add(XMaterial material, double percentage) {
