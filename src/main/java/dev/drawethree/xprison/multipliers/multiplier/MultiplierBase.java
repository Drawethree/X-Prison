...
@Getter
public abstract class MultiplierBase implements Multiplier {
	...
	MultiplierBase(double multiplier, TimeUnit timeUnit, long duration) {
		this.multiplier = multiplier;
		this.endTime = System.currentTimeMillis() + timeUnit.toMillis(duration);
	}

	MultiplierBase(double multiplier, long endTime) {
		this.multiplier = multiplier;
