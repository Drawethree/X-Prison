...
| Step | Page |
|------|------|
| 1. Install & configure | [Setup](https://github.com/Drawethree/X-Prison/wiki/Setup) |
| 2. Learn the commands | [Commands & Permissions](https://github.com/Drawethree/X-Prison/wiki/Commands-&-Permissions) |
| 3. Customize enchants | [Default Enchant Configs](#default-enchant-configs) |
| 4. See what changed | [Changelog](https://github.com/Drawethree/X-Prison/wiki/Changelog) |
...
* [Changelog](https://github.com/Drawethree/X-Prison/wiki/Changelog)
...
* [_currencies.yml_](https://github.com/Drawethree/X-Prison/wiki/currencies.yml)
...
**Passive** — always active while holding your pickaxe
...
**Currency Rewards** — chance-based currency drops on each block broken
* [_tokenfinder.json_](https://github.com/Drawethree/X-Prison/wiki/tokenfinder.json)
...
**Key & Item Rewards** — chance-based crate key and item drops
...
* [_robotfinder.json_](https://github.com/Drawethree/X-Prison/wiki/robotfinder.json)

**Area of Effect** — break multiple blocks at once
...
* [_laserbeam.json_](https://github.com/Drawethree/X-Prison/wiki/laserbeam.json)

**Multipliers** — boost the rewards of other enchants
* [_gem-merchant.json_](https://github.com/Drawethree/X-Prison/wiki/gem-merchant.json)
* [_token-merchant.json_](https://github.com/Drawethree/X-Prison/wiki/token-merchant.json)
* [_blockbooster.json_](https://github.com/Drawethree/X-Prison/wiki/blockbooster.json)

**Templates** — copy and rename these to create custom enchants
